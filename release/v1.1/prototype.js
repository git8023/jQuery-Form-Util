...
// *
// * @param useOriginal
// * {Boolean} true-直接将字符串转换为正则表达式, false-为原字符串添加开始和结束限制.
// * @returns {RegExp} 转换后的正则表达式, null-转换失败
// */
// String.prototype.convertToRegExp = function(useOriginal) {
// var REGEXP_START = "/^";
// var regexp = null;
// // 长度非法, 结束转换
// if (!this.length) { return regexp; }
//
// // 修正正则表达式元字符
//    
//
 ...
 * 
 * @param predicate
 *            {Function} predicate 断言测试函数. 参数:元素值; 返回值:true-保留;
